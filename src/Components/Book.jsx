...
const Book = ({ book }) => {
    return (
        <Link to={`../book/${book.isbn13}`}>
            <div className='overflow-hidden relative transition duration-200 transform hover:-translate-y-2 rounded shadow hover:shadow-2xl'>
                <img src={book.image} alt="Book Cover" className='object-cover w-full h-56 md:h-64 lg:h-80' />
